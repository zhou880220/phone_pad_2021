...
public class Constant {
    ...
    public static final String text_upload_multifile = "http://139.9.172.71:18080/api-f/upload/multifile"; //上传图片
    public static final String text_headPic = "http://139.9.172.71:18080/api-u/headPic"; //获取头像是否修改成功
    //接口调用
